...
Each with differnt roll size (dice) and position.
Then initially, both the player doesn't have the ball.
But, then one gets the ball with ball_toggle(), and 
handsoff to the other player. The test assumes
dice rolls results differently.
'''
